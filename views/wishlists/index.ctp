								...
								<tr class="product-row" data-type="product-row" data-product-id="<?php echo $product_id ?>" data-combination-id="<?php echo $combination_id ?>">
									...
									<td class="product-data">
										...
										<?php
											...
											echo $this->element(
												TEMPLATE_NAME.DS.'wishlist'.DS.'ias',
												array(
										...
										<div class="remove">
											<a data-toggle="modal" href="#DeleteProduct<?php echo $product_id ?>_<?php echo $combination_id ?>" role="button" title="<?php echo h(__('Usuń produkt ze schowka', true)) ?>">
												<span>x</span> <?php __('usuń ze schowka') ?>
											</a>
									...
									<?php if (userAccessToAddToCart()): ?>
										...
										<td class="product-summary">
											<input class="btn btn-form-size btn-primary pull-right" type="submit" name="data[Wishlist][<?php echo $key ?>][add_to_cart]" value="<?php echo h(getCartIsOffer() ? __('Do oferty', true) : __('Do koszyka', true)) ?>">
										</td>
									<?php endif ?>
								</tr>
