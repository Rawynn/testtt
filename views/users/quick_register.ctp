	...
	<div class="page-content-container">
		<div class="page-content page-sidebar-true">
			...
			<?php elseif (isset($code)): ?>
				<?php if ($register_account_exists): ?>
					<p class="message info">
						<?php echo sprintf(__('UWAGA - Konto %s zostało juz utworzone. Jeśli chcesz przenieść zamówienie do konta %, wprowadź aktualne hasło do konta poniżej', true), $register_account_exists['User']['email'], $register_account_exists['User']['email']) ?>:
					</p>
				<?php endif ?>
				...
				?>
					<?php if ($register_account_exists): ?>
						...
						<div class="form-actions align-input">
							<input class="btn-next btn btn-primary btn-lg" type="submit" value="<?php echo h(__('Przypisz do konta', true)) ?>">
						</div>
					<?php else: ?>
						<?php
							echo $this->Form->input(
