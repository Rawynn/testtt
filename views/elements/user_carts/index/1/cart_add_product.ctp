				...
				<div class="modal-body">
					...
					?>
						<div class="form-inner">
									...
									<?php
										...
										echo $this->Form->input(
											...
											array(
												...
												'data-ac'                   => 'true',
												'data-ac-url'               => $this->Html->url(getUserCartProductsAutocompleterUrl(array('type' => 'full'))),
										...
										if (setting('MODULE_B2B_OFFER_ALLOW_NOT_EXISTS_PRODUCTS')):
											echo $this->Form->input(
												'NewProduct.price',
												array(
													'type'      => 'text',
							...
							<div data-type="user-cart-add-product-id-container">
								<div data-type="products-list"></div>
							</div>
