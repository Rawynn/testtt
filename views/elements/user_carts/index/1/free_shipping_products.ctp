<?php $products = $deficiency > 0 ? getRecommendedProductsForUser(3, $deficiency, array_unique(Set::extract(getCartProducts(), '{n}.product_id')), !setting('GLOBAL_INCLUDE_SPECIALS_IN_SHIPPING_METHODS_FREE_FROMS')) : array() ?>
