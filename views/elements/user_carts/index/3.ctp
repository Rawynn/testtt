...
?>
	<div class="clearfix">
		<div class="order-form left">
			...
			<?php if (checkCanAddUserAddress(true)): ?>
				...
				<div class="form-inner <?php echo $vat_addresses ? 'form-hide' : '' ?>">
						...
						<?php
							echo $this->element(
								...
								array(
									...
									'show_user_type'   => true,
									'gus'              => module('GUS'),
									'user_type_label'  => __('Kupuję jako', true).':'
								)
							)
						?>
						...
						<?php
							...
							echo $this->element(
								...
								array(
									...
									'show_user_type'          => true,
									'user_type_label' 		  => __('Wysyłka do', true).':'
								)
							)
						?>
					</div>
	...
	<div class="order-form clear">
		<h2>
			<?php __('Komentarz do zamówienia') ?>
		</h2>
		...
		<div class="form-actions">
			<a class="btn-back btn btn-link btn-lg" href="<?php echo $this->Html->url(getCartUrl(1)) ?>" title="<?php echo h(__('Strona główna', true)) ?>">
				<?php __('Powrót do zakupów') ?> <i class="fa fa-angle-right"></i>
			</a>
			
			<button class="btn-next btn btn-primary form-submit btn-block btn-lg" type="submit"><?php __('Zamawiam')?> <i class="fa fa-angle-right"></i></button>
