			...
			<div class="modal-body">
				...
				?>
						...
						<?php if (module('GUS')): ?>
							<?php
								echo $this->Form->input(
									...
									array(
										'type'        => 'text',
										'data-type'   => 'user-cart-send-offer-nip-'.$id,
										'label'       => __('NIP', true).':',
										'class'       => 'form-control',
										'data-prefix' => 'send-offer',
										'data-id'     => $id,
										'div'         => array(
											'tag'       => 'div',
											'class'     => 'form-row',
							...
							<script>
								var options_tmp = {
									...
									onInvalid: function(val, e, f, invalid, options){
										...
										if ($("[data-type=nip-row]").find(".nip-info").length == 0){
											$("[data-type=nip-row]").append("<div class='nip-info'>Poprawny format nr NIP to: 5482643867 lub PL5482643867</div>");
										}
									}
								};
							
								$("[data-type=nip-row] > input").mask('ZZ000000000000000', options_tmp);
					...
					<div class="toggle-box">
						...
						<div class="form-row" data-id="ShowComment">
							<label for="UserCartCommentsOnPdf<?php echo $id ?>">
								&nbsp;
							</label>
