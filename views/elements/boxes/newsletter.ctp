			...
			?>
				...
				<?php
					 echo $this->Form->input(
						...
						array(
							'type'		=> 'checkbox',
							'data-type' => 'validate-checkbox',
							'div'		=> 'form-row checkbox',
							'label'		=> sprintf(
											__('Wyrażam zgodę na przetwarzanie moich danych osobowy zgodnie z %s', true),
											$this->Html->link(
												__('Polityką prywatności', true),
												getStaticPageUrl(6),
												array(
													'target' => '_blank',
													'rel' => 'nofollow'
				...
				<?php if ((isset($show_groups) ? $show_groups : false) && $newsletter_groups = getNewsletterGroupsList()): ?>
