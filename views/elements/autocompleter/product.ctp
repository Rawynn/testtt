<div class="product-box small product" data-product-id="<?php echo $product_id ?>" data-has-combinations="<?php echo (int) getProductField($product_id, 'has_combinations') ?>">
