			...
			<tr>
				...
				<td>
					...
					<?php if (userIsSalesrep()): ?>
						<i class="fa fa-info-circle" data-toggle="tooltip" title="<?php echo h(sprintf(__('Zmiana: %s', true), showDateTime($order['LastOrderStatusHistory']['created']).' - '.$order['LastOrderStatusHistory']['username'])) ?>"></i>
					<?php endif ?>
				</td>
