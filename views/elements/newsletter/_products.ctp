<?php
	...
	foreach ($products as $key => $product_id) :
		$__products[ceil(($key + 1)/ 3) - 1][] = $product_id;
	endforeach;
	
	$products = $__products;
?>

<table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #333333;">
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="700">
					<tr>
						<?php foreach ($__products as $__key => $product_id): ?>
							...
							?>
							<td width="220" style="text-align: center; padding: 20px 0;">
