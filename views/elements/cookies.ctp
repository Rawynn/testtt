					...
					<p>
						<?php
							echo sprintf(
								...
								$this->Html->link(__('w polityce prywatności', true), getStaticPageUrl(getStaticPagePrivacyId()))
							)
						?>
					</p>
				</div>
