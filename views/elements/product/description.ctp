<?php if($description):?>
	<div class="product-description cms-content <?php echo (!$is_expensive && ($attributes || $kit_products)) ? 'less': '' ?>" itemprop="description">
...
<div class="product-specification <?php echo ($description && !$is_expensive) ? '' : 'more_prod'?>">
