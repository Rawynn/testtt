<li data-type="opinion-container" data-product-opinion-id="<?php echo $opinion['ProductOpinion']['id'] ?>">
	...
	<span class="opinion-option opinion-note">
		...
		<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
			<meta itemprop="ratingValue" content="<?php echo $opinion['ProductOpinion']['note'] ?> ">
		</div>
	...
	<?php if ($product_list): ?>
		<div class="opinion-author">
			<meta itemprop="author" content="<?php echo $opinion['ProductOpinion']['username'] ?> ">
	...
	<span class="opinion-option opinion-publish-date" itemprop="datePublished" >
	...
	<div class="opinion-content" itemprop="reviewBody">
