<div class="user-address-list-page user-page page">
	...
	<div class="page-content-container">
							...
							<div class="row">
								...
								<div class="column-right">
									<div class="user-address-options">
										<a class="btn btn-pink" href="<?php echo $this->Html->url(getUserAddressesEditUrl($address['UserAddress']['id'])) ?>" title="<?php echo h(__('Edytuj', true)) ?>" <?php echo !checkCanAddUserAddress(false, $address, 'edit') ? 'disabled="disabled"' : '' ?>>
											<?php __('Edytuj') ?>
										</a>
		...
		<div class="page-sidebar">
			<h2><?php __('Chcesz dodać nowy adres?')?></h2>
			<a class="btn btn-primary btn-lg btn-block" href="<?php echo $this->Html->url(getUserAddressesEditUrl()) ?>" title="<?php echo h(__('Dodaj nowy adres', true)) ?>" <?php echo !$can_edit ? 'disabled="disabled" ': '' ?>>
				<?php __('Dodaj nowy adres') ?>
			</a>
