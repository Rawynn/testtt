			...
			?>
				...
				<div class="form-inner form-inner-wider">
					...
					<div class="form-actions">
						<a class="btn-back btn btn-link btn-lg" href="<?php echo $this->Html->url(getPageParamValue('redirect_to') ? getPageParamValue('redirect_to') : getUserAddressesUrl()) ?>" title="<?php echo h(__('Anuluj', true)) ?>">
							<?php __('Anuluj') ?>
						</a>
