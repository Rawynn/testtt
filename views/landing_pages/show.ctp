<div class="landing-page list-page text-page page">
	...
	<div class="page-content">
		...
		<?php if ($products): ?>
			<ul class="product-list gallery col-5" data-type="product-list" data-from="landing-page" data-url="<?php echo $this->Html->url(getLandingPageClickUrl($landing_page['LandingPage']['id'])) ?>" data-campaign-id="<?php echo $landing_page['LandingPage']['campaign_id'] ?>">
				<?php
