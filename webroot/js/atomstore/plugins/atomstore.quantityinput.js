(function($){
	...
	QuantityInput.prototype.modulo = function(x, y){
		x = x.toFixed(this.options.precision) * this.options.multiplier;
		y = y.toFixed(this.options.precision) * this.options.multiplier;
		
		x = x.toFixed(0);
		y = y.toFixed(0);
		
		return (x % y * this.options.multiplier / this.options.multiplier).toFixed(this.options.precision);
	};
